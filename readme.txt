...
Project Details:
    ...
    -Assertions are Performed through the TestCase Object using TestNg SoftAsserts and reported as
        a combination of TestNG's reporting and Extent Reports'.
    -Background Work for the Test including test setup and test case setup can be found in
        '\src\test\java\TestNG\TestRunnerBase.java'.
    -Shouldn't need to worry about binaries for Selenium because the WebDriverManager Dependency
        should be able to download the correct binaries on mac or windows during the test run.